  ...
  return (
    <MainContainer>
      ...
      <SectionContainer>
        ...
        <AboutText>
          これは「primeNumber DATA SUMMIT 2025」に出展した方への出展者ページです。各種のファイルのダウンロードや申請が行えます。
        </AboutText>
        ...
        <FeaturesGrid>
          ...
          <FeatureCard to="/downloads">
            ...
            <FeatureDescription>
              会場マップ、スポンサーガイド、出展者マニュアルなどの各種資料をダウンロードできます。イベント参加に必要な情報を事前にご確認ください。
            </FeatureDescription>
            <ArrowIcon>→</ArrowIcon>
          </FeatureCard>
          ...
          <FeatureCard to="/submissions-and-forms">
            ...
            <FeatureTitle>提出物・各種フォーム</FeatureTitle>
            <FeatureDescription>
              スピーカー・出展者の方はこちらから必要な提出物や期限をご確認いただけます。各種申請フォームへのアクセスもこちらから可能です。
            </FeatureDescription>
            <ArrowIcon>→</ArrowIcon>
          </FeatureCard>
        </FeaturesGrid>
        ...
        <EventInfoContainer>
          ...
          <EventTable>
            ...
            <tbody>
              ...
              <TableRow>
                <TableCell>2025年8月22日（金）</TableCell>
                <TableCell>ロゴデータ/会社情報提出シート締切、講演情報確認シート/講演者写真締切</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>2025年9月下旬</TableCell>
                <TableCell>イベントサイトオープン</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>2025年10月初旬</TableCell>
                <TableCell>オンライン説明会</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>2025年10月31日（金）</TableCell>
                <TableCell>ブース情報確認シート締切、セッション環境確認シート締切、幕間CM締切、スポンサー費ご入金期限</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>2025年11月21日（金）</TableCell>
          ...
          <EventInfoGrid>
            <EventInfoItem>
              ...
              <InfoContent>
                ...
                <InfoText>スポンサー事務局: primenumber_sponsor2025@eventdesk.info</InfoText>
              </InfoContent>
            </EventInfoItem>
